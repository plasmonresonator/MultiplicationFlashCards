...
def do_level(level, values, common, name, i):
	...
	try:
		...
		with open(indiv_filename, 'a+') as ff:
			with open('Ashlyn multiplaction results.txt', 'a+') as f:
...
print('\n\n')
name = input('Hello, thanks for wanting to play Daddy\'s super amazing addition game!!!\n\nPlease type your name:\t')
if str.lower(name) == 'ashlyn':
	pass
else:
	print("\nEither you're trying to trick me, OR you spelled you're name wrong!  I'm going to call you Ashlyn McStinkerButt for now!",
		"anyway! :-)\n\n")
	name = 'Ashlyn McStinkerButt'
